...
# 3. Demo:
After download and unzip the zip file from the "Code" above, please double click the file of "Analog_Clock.sln" file. Then, you can create an executable file for the Analog Clock as below. If you execute the program, you can change the clock face and/or clock hands, etc. by right click the clock icon at the "TASKBAR".   
